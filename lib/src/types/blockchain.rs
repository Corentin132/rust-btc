...
impl Blockchain {
    ...
    pub fn try_adjust_target(&mut self) {
        ...
        let time_diff_seconds: i64 = time_diff.num_seconds();
        ...
        let new_target: U256 = U256::from_str_radix(&new_target_str, 10).expect("BUG: impossible"); // clamp new_target to be within the range of
